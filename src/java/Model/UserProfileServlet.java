    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (oldPassword != null && newPassword != null) {
            if (user.validateEditPassword(id, oldPassword, newPassword)) {
                ...
                String result = user.changePassword(id,oldPassword,newPassword);
                Utils.showAlert(out, result, request, response, "controller?action=userprofile");
            }
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (editprofile != null && editprofile.equalsIgnoreCase(editprofile)) {
            ...
            if (valid.equals(user.editUser(id,editname,editemail,editaddress))) {
                ...
                String err = user.editUser(id, editname, editemail, editaddress);
                Utils.showAlert(out, err, request, response, "controller?action=userprofile");
            }
